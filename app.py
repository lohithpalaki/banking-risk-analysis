...
if not st.session_state.logged_in:
    st.title("\U0001F510 Login to Banking Dashboard")
...
if section == "Customer Demographics & Overview":
    st.title("\U0001F4CA Customer Demographics & Overview")
    ...
    fig2 = px.bar(x=age_group_counts.index, y=age_group_counts.values,
                  ...
                  title="Age Group wise Number of Customers", text=age_group_counts.values)
    ...
    fig3 = px.bar(city_count, x='Count', y='City', orientation='h', title="Customer Count by City", text='Count')
